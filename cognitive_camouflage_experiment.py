...
USAGE:
    ...
    python cognitive_camouflage_experiment.py --out paper/cognitive_camouflage_results.json
"""
...
parser.add_argument("--out", default="paper/cognitive_camouflage_results.json")
...
THESIS_SPECIMENS = [
    {
        ...
        "thesis_file": f"{BASE}/recursive_bayesian/history/v2_score_65.md",
    ...
    },
    {
        ...
        "thesis_file": f"{BASE}/ai_inference_collapse/history/v2_score_70.md",
    ...
    },
    {
        ...
        "thesis_file": f"{BASE}/tsmc_fragility/history/v11_score_75.md",
    ...
    },
    {
        ...
        "thesis_file": f"{BASE}/simulation_god/thesis.md",
    ...
    },
    {
        ...
        "thesis_file": f"{BASE}/epistemic_engine_v3/history/1775133604_iter2_score_370_epistemic_engine_v3_evolved.md",
