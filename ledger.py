...
Usage:
    python ledger.py              # scan and append new predictions
    python ledger.py --report     # print calibration summary
"""
...
def print_report():
    if not os.path.exists(LEDGER_PATH):
        print("❌ No ledger found. Run: python ledger.py")
        return
