...
USAGE:
    python baseline_experiment.py                          # Gemini only
    python baseline_experiment.py --all                    # All available providers
    python baseline_experiment.py --model gemini-2.5-pro   # Specific Gemini model
    python baseline_experiment.py --claude claude-sonnet-4-6  # Specific Claude model
    python baseline_experiment.py --out paper/baseline_results.json
"""
...
parser.add_argument("--out", default="paper/baseline_results.json", help="Output path")
